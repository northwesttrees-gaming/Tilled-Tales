...
public class GreenMixingBowlBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(10, ItemStack.EMPTY);

	public GreenMixingBowlBlockEntity(BlockPos position, BlockState state) {
		super(TilledTalesModBlockEntities.GREEN_MIXING_BOWL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("green_mixing_bowl");
	}
