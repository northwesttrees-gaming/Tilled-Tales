...
public class YellowMixingBowlBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(10, ItemStack.EMPTY);

	public YellowMixingBowlBlockEntity(BlockPos position, BlockState state) {
		super(TilledTalesModBlockEntities.YELLOW_MIXING_BOWL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("yellow_mixing_bowl");
	}
