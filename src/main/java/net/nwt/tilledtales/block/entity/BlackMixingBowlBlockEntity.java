...
public class BlackMixingBowlBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(10, ItemStack.EMPTY);

	public BlackMixingBowlBlockEntity(BlockPos position, BlockState state) {
		super(TilledTalesModBlockEntities.BLACK_MIXING_BOWL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("black_mixing_bowl");
	}
