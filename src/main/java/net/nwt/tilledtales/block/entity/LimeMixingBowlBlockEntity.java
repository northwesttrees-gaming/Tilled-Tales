...
public class LimeMixingBowlBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(10, ItemStack.EMPTY);

	public LimeMixingBowlBlockEntity(BlockPos position, BlockState state) {
		super(TilledTalesModBlockEntities.LIME_MIXING_BOWL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("lime_mixing_bowl");
	}
