...
public class BlueMixingBowlBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(10, ItemStack.EMPTY);

	public BlueMixingBowlBlockEntity(BlockPos position, BlockState state) {
		super(TilledTalesModBlockEntities.BLUE_MIXING_BOWL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("blue_mixing_bowl");
	}
